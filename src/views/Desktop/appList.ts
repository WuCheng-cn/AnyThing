...
import BingIcon from '@/assets/img/appIcon/bing.svg'
...
const CloudMusic = AnyComponentHelper.asyncComponent(() => import('@/views/Desktop/WebApp/CloudMusic.vue'))
const Setting = AnyComponentHelper.asyncComponent(() => import('@/views/Desktop/LocalApp/Setting/index.vue'))
const Bing = AnyComponentHelper.asyncComponent(() => import('@/views/Desktop/WebApp/Bing.vue'))
...
export const DefaultTaskAppList = [
  ...
  new AppEntity().assign({
    name: '必应搜索',
    icon: BingIcon,
    handler: handler(Bing, {}, { title: '必应搜索' })
  }),
]